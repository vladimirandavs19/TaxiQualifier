...
namespace Taxi.Prism.ViewModels
{
    public class TaxiHistoryPageViewModel : ViewModelBase
    {
        ...
        private List<TripItemViewModel> tripItemViewModels;
        ...
        public List<TripItemViewModel> TripItemViewModels
        {
            get => tripItemViewModels;
            set => SetProperty(ref tripItemViewModels, value);
        }
        ...
        private async void CheckPlaqueAsync()
        {
            ...
            TripItemViewModels = Taxi.Trips.Select(t => new TripItemViewModel(_navigationService)
            {
                EndDate = t.EndDate,
                Id = t.Id,
